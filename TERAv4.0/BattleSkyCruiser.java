...
public class BattleSkyCruiser{
    ...
    public BattleSkyCruiser(Enemy e, Character c){
        /*
    ...
    public void fightPriest(){
        ...
        else if (boss instanceof TrollPerimos){
            perimosmusic.play();
            System.out.println("You encountered Perimos, the super lazer demon!");
        }
        else{
            darkanmusic.play();
        ...
        while (boss.getHealth() > 0){
            if(player.getHealth() > 0){
                ...
                if(playerDMG < 0){
                    ...
                    System.out.println("Damage dealt: " + Math.abs((int)((player.getWeapon().getBMult())*playerDMG)));
                    System.out.println("Damage taken: " + Math.abs((int)((player.getChest().getCMult()*player.getGlove().getGMult()*player.getBoot().getSMult())*enemyDMG)));
                    player.changeHealth((int)((player.getChest().getCMult()*player.getGlove().getGMult()*player.getBoot().getSMult())*enemyDMG));
                    boss.changeHealth((int)((player.getWeapon().getBMult())*playerDMG));
                }
                else if(playerDMG == 0){
                    System.out.print("\f");
        ...
        if (player.getHealth()<=0){
            if (boss instanceof Perimos){
                ...
                boss.setHealth(500000000);
            else{
                boss.setHealth(1000000);                
            }
        }
        else {
            if (boss instanceof Perimos || boss instanceof TrollPerimos){
        ...
        while (boss.getHealth() > 0){
            if(player.getHealth() > 0){
                ...
                if(playerDMG < 0){
                    ...
                    System.out.println("Damage dealt: 0");
                    if (playerDMG + ((int)((player.getChest().getCMult()*player.getGlove().getGMult()*player.getBoot().getSMult())*enemyDMG)) <  0){
                        System.out.println("Damage taken: " + Math.abs(playerDMG + ((int)((player.getChest().getCMult()*player.getGlove().getGMult()*player.getBoot().getSMult())*enemyDMG))));
                        player.changeHealth(playerDMG + ((int)((player.getChest().getCMult()*player.getGlove().getGMult()*player.getBoot().getSMult())*enemyDMG)));
                    }
                    else 
                        System.out.println("Damage taken: 0");
                }

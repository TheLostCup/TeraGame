public class SkyCruiserMap{
    ...
    public SkyCruiserMap(){
        ...
        layout[4][0] = new Perimos(4, 0);
        layout[4][1] = new Perimos(4, 1);
        layout[4][2] = new TrollPerimos(4, 2);
        layout[4][3] = new Perimos(4, 3);
        layout[4][4] = new Perimos(4, 4);
        ...
        layout[8][0] = new TantibusScale();
        layout[8][3] = new TantibusScale();
        layout[3][0] = new TantibusScale();
        layout[1][2] = new TantibusScale();
    }
